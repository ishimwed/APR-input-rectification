...
//int __attribute__((__$input__))  c_0  ;
//int __attribute__((__$input__))  c_1  ;
//int __attribute__((__$input__))  c_2  ;
//int __attribute__((__$input__))  c_3  ;
//int __attribute__((__$input__))  c_4  ;
//int __attribute__((__$input__))  c_5  ;
//int __attribute__((__$input__))  c_6  ;
//int __attribute__((__$input__))  c_7  ;
//int __attribute__((__$input__))  c_8  ;
//int __attribute__((__$input__))  c_9  ;
//int __attribute__((__$input__))  c_10  ;
//int __attribute__((__$input__))  c_11  ;
...
{
x_new = ((c_0 * -94 + c_1 * -94) + (c_2 * -31 + c_3));
y_new = ((c_4 * -94 + c_5 * -94) + (c_6 * -31 + c_7));
z_new = ((c_8 * -94 + c_9 * -94) + (c_10 * -31 + c_11));
rb1 = buggyQ(x_new, y_new, z_new);
rc1 = correctQ(-94, -94, -31);
x_new = ((c_0 * -26 + c_1 * -11) + (c_2 * 100 + c_3));
y_new = ((c_4 * -26 + c_5 * -11) + (c_6 * 100 + c_7));
z_new = ((c_8 * -26 + c_9 * -11) + (c_10 * 100 + c_11));
rb2 = buggyQ(x_new, y_new, z_new);
rc2 = correctQ(-26, -11, 100);

x_new = (c_0 * -26 + c_1 * -11) + (c_2 * 100 + c_3);
y_new = (c_4 * -26 + c_5 * -11) + (c_6 * 100 + c_7);
z_new = (c_8 * -26 + c_9 * -11) + (c_10 * 100 + c_11);
rb3 = buggyQ(x_new, y_new, z_new);
rc3 = correctQ(-26, -11, 100);
if ((rb1 == rc1 && rb2 == rc2) && rb3 == rc3) {
$pathCondition();
$assert(0);
}
}
